...
class AuthenticationHelper extends FingerprintManagerCompat.AuthenticationCallback
  ...
  private void updateFingerprintDialog(DialogState state, String message) {
    ...
    switch (state) {
      ...
      case SUCCESS:
        ...
        if (call.argument("theme").equals("libra")) {
          resultInfo.setTextColor(ContextCompat.getColor(activity, R.color.success_color_libra));
        }
        break;
    }
  ...
  private void showFingerprintDialog() {
    ...
    fpDescription.setTextColor(ContextCompat.getColor(activity, R.color.text_color_libra));
    status.setTextColor(ContextCompat.getColor(activity, R.color.text_color_hint_libra));
    if (call.argument("theme").equals("libra")) {
      dialogStyle = R.style.AlertDialogLibra;
      fpIcon.setImageDrawable(ContextCompat.getDrawable(activity, R.drawable.fingerprint_initial_icon_libra));
    }
